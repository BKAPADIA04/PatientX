...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService("AuthService",
            ...
            List.of(4005),
            authServiceDb,
            Map.of("JWT_SECRET", "adebd7cc9cd4a2e0376830c17c831f178ac9204a3a69fad0711db49565c4e8f99963c0766ed390aa60a73de5210a5ee91149c534bef356959eb7babb16495fff"));
        ...
        FargateService patientService = createFargateService("PatientService",
            ...
            patientServiceDb,
            Map.of(
                "BILLING_SERVICE_ADDRESS", "host.docker.internal-net",
    ...
    ContainerDefinitionOptions containerOptions =
        ContainerDefinitionOptions.builder()
            ...
            .environment(Map.of(
                ...
                "AUTH_SERVICE_URL", "http://host.docker.internal-net:4005"
            ))
